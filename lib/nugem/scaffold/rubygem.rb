module Nugem
  method_option :host, type: :string, default: 'github', enum: %w[bitbucket github gitlab], desc: 'Repository host.'

  method_option :private, type: :boolean, default: false, desc: 'Publish the gem in a private repository.'
  ...
  def create_plain_scaffold(gem_name)
    ...
    puts "create_plain_scaffold: Creating a scaffold for a new Ruby gem named #{@gem_name} in #{@out_dir}.".green
